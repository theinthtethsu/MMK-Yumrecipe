      ...
      <div class="flex flex-col md:flex-row items-center gap-4">
        ...
        <div>
          ...
          <p class="text-sm">A frozen scallion pancake, loaded with eggs, spinach, avocado, and chili crisp! A
            five-minute meal perfect for breakfast, lunch, or dinner!</p>
        </div>
      </div>
    </div>
    ...
    <div class="bg-white shadow-md rounded-lg p-4 mt-4 dark:bg-gray-700 dark:text-white">
      ...
      <ul class="space-y-4">
        <li class="flex items-start">
          <input type="checkbox"
            class="mt-1 h-5 w-5 border-red-500 rounded checked:bg-red-500 checked:border-red-500 focus:ring-red-500"
            onchange="toggleStrike(this)">
          <label class="ml-4">
            <span class="font-bold text-red-500">Fry Up Your Scallion Pancake.</span><br>
            <span class="text-sm">The ones from Trader Joe's come frozen and individually wrapped. Toast or fry on both
              sides till nice and golden and yummy! It's flaky, chewy, very carb-forward in the best way.</span>
          </label>
        </li>
        <li class="flex items-start">
          <input type="checkbox" class="mt-1 h-5 w-5 text-red-500 rounded" onchange="toggleStrike(this)">
          <label class="ml-4">
            <span class="font-bold text-red-500">Fry Some Eggs.</span><br>
            <span class="text-sm">In the same pan, throw a couple eggs in there. Scallion pancake is coming on top in
              three, two...</span>
          </label>
        </li>
        <li class="flex items-start">
          <input type="checkbox" class="mt-1 h-5 w-5 border-red-500 rounded" onchange="toggleStrike(this)">
          <label class="ml-4">
            <span class="font-bold text-red-500">Squish that Pancake on Top.</span><br>
            <span class="text-sm">Scallion pancake goes on top, pressing it down gently to break the yolks and adhere to
              the eggs as they finish cooking.</span>
          </label>
        </li>
        <li class="flex items-start">
          <input type="checkbox" class="mt-1 h-5 w-5 text-red-500 rounded" onchange="toggleStrike(this)">
          <label class="ml-4">
            ...
            <span class="text-sm">For me, avocado and chili crisp. But I also like this with a slice or two of American
              cheese. Roll it up and go! Yum!</span>
          </label>
        </li>
      </ul>
