   ...
   <?php include_once '../../../common/nav.php'; ?>
    ...
    <div class="max-w-screen-lg mx-auto px-4 py-4 mt-14">
      ...
      <header class="text-center mb-20 md:mb-16">
        ...
        />
        <h1 class="text-5xl font-bold tracking-tight mb-2">Welcome to our Blog</h1>
      ...
      <div
        class="grid grid-cols-2 md:grid-cols-[14rem_1fr] gap-24 items-center"
      >
        <!-- Left Sidebar -->
        ...
        <div>
          <article class="mb-12">
            ...
            <p class=" text-lg text-gray-600 mb-4 leading-7">
              Ever wondered where to find the most mouthwatering burgers on the
              planet? From classic American staples to gourmet international
              creations, here’s a global journey to discover the best burgers
              you must try!
            </p>
            <img
            ...
            <div class="prose max-w-none">
              ...
              <div class="text-lg leading-7">
                <p class="mb-4">
                    <h1> The Classic: USA – The Heart of the Burger World 🍔</h1> <br>It’s no
                    surprise that the United States, the home of the burger, is
                    where you’ll find some of the best. New York, Los Angeles, and
                    Chicago are overflowing with iconic joints. The ‘Double
                    ShackBurger’ from Shake Shack or the legendary ‘In-N-Out
                    Double-Double’ are life-changing experiences for burger lovers.
                    For a gourmet option, head to New York’s ‘Black Label Burger’ at
                    Minetta Tavern — juicy dry-aged beef that melts in your mouth.
                    Fun Fact: The cheeseburger was “accidentally” invented in the
                    1920s when a chef in California dropped a slice of cheese on a
                    beef patty!
                  </p>
    
                  <p>
                    <h1></h1><br> Japan takes burgers
                    to a new level of decadence. Imagine a burger made with buttery,
                    melt-in-your-mouth Wagyu beef. The ‘Ginza Wagyu Burger’ in Tokyo
                    combines premium Japanese beef with truffle mayo, caramelized
                    onions, and a toasted brioche bun. It’s rich, indulgent, and
                    worth every yen. Why Japan? Wagyu beef is famous for its
                    marbling, making it one of the most tender meats in the world.
                  </p>
