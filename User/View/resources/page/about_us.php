  ...
  <?php include('../../common/nav.php'); ?>
    <section class="w-full px-4 py-8">
      <div class="max-w-screen-xl mx-auto grid grid-cols-1 md:grid-cols-2 items-center gap-x-5">
        ...
        <div>
          <img src="../img/DrawKit Vector Illustrations Company Teamwork (6).png" alt="About Us" class="w-full" />
        </div>
      </div>
    </section>
    <section class="w-full px-4 py-8 mb-36">
      <div class="max-w-screen-xl mx-auto">
        <h2 class="text-3xl md:text-4xl font-bold text-center mb-12">Our Writers</h2>
