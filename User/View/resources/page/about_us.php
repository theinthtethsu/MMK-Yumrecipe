...
<html lang="en">
  ...
  <?php include_once '../../common/nav.php'; ?>
    <section class="w-screen bg-red-50">
      ...
      >
        <div>
          <h1 class="text-3xl md:text-5xl font-bold tracking-tight mb-8">
            About Us
          </h1>
          <p class="text-base md:text-lg text-gray-600 leading-7">
            We’re passionate about bringing people together through the joy of
            cooking and sharing recipes. Our platform combines personal recipe
            management with a vibrant community of food enthusiasts, making it
            easy to save your favorite dishes, explore new cuisines, and connect
            with like-minded creators. Join us in celebrating the art of cooking
        ...
        <div>
          <img
            src="../img/DrawKit Vector Illustrations Company Teamwork (6).png"
            alt="About Us"
            class="w-full"
          />
        </div>
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-8">
          ...
          <div class="text-center">
            ...
            <p class="text-gray-600 mb-4">
              "As a professional chef, I love sharing authentic Asian recipes
              and cooking techniques that bring families together."
            </p>
          ...
          <div class="text-center">
            ...
            <p class="text-gray-600 mb-4">
              "I specialize in Mediterranean cuisine and love exploring the rich
              flavors and healthy ingredients that make these dishes special."
            </p>
            <div class="flex justify-center gap-4">
              <a href="#" class="text-red-500 hover:text-red-600">
                <svg class="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
          ...
          <div class="text-center">
            ...
            <p class="text-gray-600 mb-4">
              "My passion is creating simple, delicious desserts that anyone can
              make. I believe baking should be fun and accessible to everyone."
            </p>
            <div class="flex justify-center gap-4">
              <a href="#" class="text-red-500 hover:text-red-600">
                <svg class="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
