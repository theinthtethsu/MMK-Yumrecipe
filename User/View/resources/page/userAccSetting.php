...
<div class="flex-1 flex flex-col bg-gray-50 dark:bg-gray-900 px-11 py-5">
  ...
  <!-- Preferences Section -->
 <!-- Preferences Section -->
 <div class="bg-white dark:bg-gray-800 dark:text-white rounded-lg shadow-md p-6">
    ...
    <div class="flex flex-wrap gap-2">
      ...
      <div class="flex items-center space-x-2 border border-gray-300 rounded-full px-3 py-1 text-sm text-gray-700">
        <span class="dark:text-white">Japanese</span>
        <button class="text-gray-500 hover:text-gray-700 focus:outline-none dark:text-white dark:hover:text-red-500">
          ✕
        </button>
      </div>
      <!-- Repeat for each tag -->
      <div class="flex items-center space-x-2 border border-gray-300 rounded-full px-3 py-1 text-sm text-gray-700">
        <span class="dark:text-white">Heart-healthy</span>
        <button class="text-gray-500 hover:text-gray-700 focus:outline-none dark:text-white dark:hover:text-red-500">
          ✕
        </button>
      </div>
      <div class="flex items-center space-x-2 border border-gray-300 rounded-full px-3 py-1 text-sm text-gray-700">
        <span class="dark:text-white">Under 15 mins</span>
        <button class="text-gray-500 hover:text-gray-700 focus:outline-none dark:text-white dark:hover:text-red-500">
          ✕
        </button>
      </div>
      <div class="flex items-center space-x-2 border border-gray-300 rounded-full px-3 py-1 text-sm text-gray-700">
        <span class="dark:text-white">Appetizer</span>
        <button class="text-gray-500 hover:text-gray-700 focus:outline-none dark:text-white dark:hover:text-red-500">
          ✕
        </button>
      </div>
      <div class="flex items-center space-x-2 border border-gray-300 rounded-full px-3 py-1 text-sm text-gray-700">
        <span class="dark:text-white">Dessert</span>
        <button class="text-gray-500 hover:text-gray-700 focus:outline-none dark:text-white dark:hover:text-red-500">
          ✕
        </button>
      </div>
      <div class="flex items-center space-x-2 border border-gray-300 rounded-full px-3 py-1 text-sm text-gray-700">
        <span class="dark:text-white">Chicken</span>
        <button class="text-gray-500 hover:text-gray-700 focus:outline-none dark:text-white dark:hover:text-red-500">
          ✕
        </button>
      </div>
      <div class="flex items-center space-x-2 border border-gray-300 rounded-full px-3 py-1 text-sm text-gray-700">
        <span class="dark:text-white">Grilling</span>
        <button class="text-gray-500 hover:text-gray-700 focus:outline-none dark:text-white dark:hover:text-red-500">
          ✕
        </button>
      </div>
      <div class="flex items-center space-x-2 border border-gray-300 rounded-full px-3 py-1 text-sm text-gray-700">
        <span class="dark:text-white">Party</span>
        <button class="text-gray-500 hover:text-gray-700 focus:outline-none dark:text-white dark:hover:text-red-500">
          ✕
        </button>
      </div>
      <div class="flex items-center space-x-2 border border-gray-300 rounded-full px-3 py-1 text-sm text-gray-700">
        <span class="dark:text-white">Family Dinner</span>
        <button class="text-gray-500 hover:text-gray-700 focus:outline-none dark:text-white dark:hover:text-red-500">
          ✕
        </button>
      </div>
      <div class="flex items-center space-x-2 border border-gray-300 rounded-full px-3 py-1 text-sm text-gray-700">
        <span class="dark:text-white">Summer</span>
        <button class="text-gray-500 hover:text-gray-700 focus:outline-none dark:text-white dark:hover:text-red-500">
          ✕
        </button>
      </div>
      <div class="flex items-center space-x-2 border border-gray-300 rounded-full px-3 py-1 text-sm text-gray-700">
        <span class="dark:text-white">Vegetarian</span>
        <button class="text-gray-500 hover:text-gray-700 focus:outline-none dark:text-white dark:hover:text-red-500">
          ✕
        </button>
      </div>
