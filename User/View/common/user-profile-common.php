    ...
    <div class="flex mt-1">
        ...
        <aside class="w-full md:w-1/5 bg-white text-black border-r text-center dark:bg-gray-900 dark:text-white">
            <ul class="mt-10 space-y-4 pl-5">
                ...
                <li class="cursor-pointer p-2 text-sm sm:text-base <?php echo basename($_SERVER['PHP_SELF']) == 'savedRecipes.php' ? 'text-white font-bold italic bg-red-500' : '' ?>">
                    <a href="<?php echo $user_path; ?>savedRecipes.php">Saved Recipes</a>
                </li>
                ...
                <li class="cursor-pointer p-2 text-sm sm:text-base <?php echo basename($_SERVER['PHP_SELF']) == 'userAccSetting.php' ? 'text-white font-bold italic bg-red-500' : '' ?>">
                    <a href="<?php echo $user_path; ?>userAccSetting.php">Setting</a>
                </li>
            </ul>
        </aside>
</body>
